...
$form->join('gym_member','ON(gym_member_paket.gym_member_id = gym_member.id)','gym_member_paket.id,gym_member.nama,gym_member.alamat,gym_member.tgl_masuk,gym_member_paket.gym_paket_id,gym_member_paket.status');

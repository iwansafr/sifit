<?php if (!empty($popular_lpk)): ?>
	<?php $bisnis = $this->esg->get_config('lpk_config') ?>
	<div class="box box-primary">
	  <div class="box-header with-border">
	    <h3 class="box-title"><?php echo $bisnis['title'] ?> Populer</h3>
	  ...
	  <div class="box-footer text-center">
	    <a href="<?php echo base_url('home/lpk/list') ?>" class="uppercase">Lihat Semua <?php echo $bisnis['title'] ?></a>
	  </div>
	</div>
<?php endif ?>